...
const drawFun = (canvasCenter, ctxCenter) => {
  ...
  drawArrow(
    ctxCenter,
    startX + (59 - 1) * w + radius,
    h / 2,
    startX + (59 + 61 - 1) * w - radius,
    h / 2,
    1,
    "#333",
    61 * w,
  ...
  drawArrow(
    ctxCenter,
    startX + (59 + 20 - 1) * w + radius,
    h / 2 - 50,
    startX + (59 + 20 + 28 + 13 - 1) * w - radius,
    h / 2 - 50,
    1,
    "#333",
    28 * w,
  ...
  drawArrow(
    ctxCenter,
    startX + (7 + 7 - 1 + 13) * w + radius,
    h / 2 + 100,
    startX + (7 + 7 - 1 + 13 + 10) * w - radius,
    h / 2 + 100,
    1,
    "#333",
    4 * w,
  ...
  drawArrow(
    ctxCenter,
    startX + (20 + 7 + 10 - 1) * w + radius,
    h / 2,
    (20 + 7 + 10 + 10 - 1) * w + radius,
    h / 2,
    1,
    "#333",
    10 * w,
