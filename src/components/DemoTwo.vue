...
const state = reactive({
  ...
  dataList: [
    { id: '1', workName: '', workTime: 0, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 1, children: [
      { id: '2', workName: '1', workTime: 7, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 7, children: [
        { id: '3', workName: '3-1', workTime: 20, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 27, children: [
          { id: '5', workName: '3-7', workTime: 10, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 37, children: [
             { id: '6', workName: '3-8', workTime: 10, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 47, children: [
               { id: '7', workName: '5', workTime: 12, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 59, children: [
                 { id: '8', workName: 'B', workTime: 20, freeTime: 0, totalCountTime: 13, isMainWork: false, totalTime: 79, children: [
                   { id: '9', workName: 'C', workTime: 28, freeTime: 13, totalCountTime: 13, isMainWork: false, totalTime: 120, children: [
                     { id: '10', workName: '', workTime: 0, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 120, children: []}
                   ]}
                 ]},
                 { id: '10', workName: 'D', workTime: 61, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 120, children: [
                   { id: '11', workName: 'F', workTime: 31, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 151, children: [] }
                 ]},
                 { id: '12', workName: 'E', workTime: 45, freeTime: 16, totalCountTime: 16, isMainWork: false, totalTime: 120, children: [
                   { id: '10', workName: '', workTime: 0, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 120, children: []}
                 ]}
               ]}
             ]}
        ...
        { id: '4', workName: '3-2', workTime: 20, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 27, children: [
           {id: '3', workName: '', workTime: 0, freeTime: 0, totalCountTime: 0, isMainWork: true, totalTime: 27, children: []}
        ]},
      ]}
    ]}
  ]
  ...
  value.forEach((item: any) => {
    if (item.isMainWork) {
      ...
      item.height = h / 2 + smallHeight * (count - 1)
        console.log(item.height, 'sda')
      drawCircle(ctxCenter, startX + (item.totalTime - 1) * w, item.height, item.id)
      if (item.children && item.children.length > 0) {
        ...
        mainWorkArray.map((child: any, childIndex: number) => {
          ...
          drawArrow(ctxCenter, startX + (item.totalTime - 1) * w + radius, item.height, startX + (child.totalTime - 1) * w - radius, child.newH, 1, '#333', child.workTime * w, child.workTime, h / 2, child.workName, child.freeTime)
        })
        notMainWorkArray.map((notMainChild: any, index: number) => {
          notMainChild.newH = ((index + 1) % 2 == 0) ? ((index + 1) / 2 >= 1 ? (index + 1) / 2 : 1) * smallHeight + item.height : (-1) * ((index + 1) / 2 >= 1 ? (index + 1) / 2 : 1) * smallHeight + h / 2
